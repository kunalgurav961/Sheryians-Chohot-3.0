  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-950 dark:text-white">Modal</h1>
        <p className="text-lg text-zinc-600 dark:text-zinc-400">
          Accessible dialog overlays for critical alerts, user confirmation, and rich modal forms.
        </p>
      </div>
