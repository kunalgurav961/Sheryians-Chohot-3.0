  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-950 dark:text-white">Card</h1>
        <p className="text-lg text-zinc-600 dark:text-zinc-400">
          The Card component is a flexible container with hover physics, 3D tilt effects, and responsive ratios.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col gap-20">
          ...
          <div className="flex flex-col gap-10">
            <h3 className="text-2xl font-bold text-zinc-900 dark:text-white">Animated Card</h3>
