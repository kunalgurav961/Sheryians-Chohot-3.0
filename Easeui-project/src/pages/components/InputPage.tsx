  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-12">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-950 dark:text-white">Input</h1>
        <p className="text-zinc-600 dark:text-zinc-400 text-lg">
          Flexible text inputs, password reveals, animated focus effects, and numeric controls.
        </p>
      </div>
      ...
      <section className="space-y-4 flex flex-col gap-10">
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium text-zinc-800 dark:text-zinc-200">Normal Inputs</h3>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-medium text-zinc-800 dark:text-zinc-200">Specialty Inputs</h3>
